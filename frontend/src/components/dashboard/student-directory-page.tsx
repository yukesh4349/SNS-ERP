...
import { getSchoolClasses, getStudentsByClass, getStudentDetails } from "../../services/mock-data-service";
...
export function StudentDirectoryPage() {
  ...
  return (
    <PageSection
      ...
      description={
        view === "classes" ? "Select a class to view its student roster and academic profiles." :
      ...
      <div className="flex flex-col gap-6">
        ...
        {view !== "classes" && (
          ...
          >
            ...
            {view === "details" ? "Back to Student List" : "Back to Classes"}
          </button>
        )}
